...
public class GlideUtils {
    ...
    public static void loadCircle(Context context, Object path,ImageView view) {
    ...
    public static void loadCircle(Context context, Object path, int errRes, int defRes, ImageView view) {
       loadCircle(context,path,errRes,defRes,view,false,-1);
    }

    public static void loadCircle(Context context, Object path, int errRes, int defRes, ImageView view,boolean withSolid,int color) {
